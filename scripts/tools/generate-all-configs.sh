#!/usr/bin/env bash
# =============================================================================
# generate-all-configs.sh — Генерация клиентских конфигов
#
# Создаёт:
...
# ---------------------------------------------------------------------------
step "1/4: Получение параметров сервера"
# ---------------------------------------------------------------------------
...
SERVER_NAME=$(echo "$SERVER_DATA" | awk '/^=NAME=/{getline; print}')
...
# ---------------------------------------------------------------------------
step "2/4: Определение клиентских ключей"
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
step "3/4: Генерация full-tunnel конфигов"
# ---------------------------------------------------------------------------
