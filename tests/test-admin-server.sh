...
check_pattern "Migration: cloak_uid"       "cloak_uid"
check_pattern "Migration: xray_uuid"       "xray_uuid"
...
check_pattern "GET  /api/cloak/status"          "/api/cloak/status"
check_pattern "POST /api/peers/<id>/cloak"      "def peers_cloak_enable"
check_pattern "DELETE /api/peers/<id>/cloak"    "def peers_cloak_disable"
check_pattern "GET  /api/peers/<id>/cloak/config"     "/cloak/config"
check_pattern "GET  /api/peers/<id>/cloak/awg-config" "/cloak/awg-config"
check_pattern "GET  /api/xray/status"            "/api/xray/status"
check_pattern "POST /api/peers/<id>/xray"        "def peers_xray_enable"
check_pattern "DELETE /api/peers/<id>/xray"      "def peers_xray_disable"
check_pattern "GET  /api/peers/<id>/xray/url"    "/xray/url"
check_pattern "GET  /api/monitoring/data"       "/api/monitoring/data"
check_pattern "GET  /api/monitoring/peers"      "/api/monitoring/peers"
check_pattern "GET  /api/monitoring/stream (SSE)" "/api/monitoring/stream"
check_pattern "GET  /api/monitoring/events"     "/api/monitoring/events"
...
check_pattern "Cloak keys loader"          "_get_cloak_keys"
check_pattern "Cloak available check"      "_cloak_available"
check_pattern "Cloak UID generation SSH"   "_generate_cloak_uid_ssh"
check_pattern "Cloak client config builder" "_build_cloak_client_config"
check_pattern "Cloak status SSH"           "_get_cloak_status_ssh"
check_pattern "XRAY keys loader"          "_get_xray_keys"
check_pattern "XRAY available check"      "_xray_available"
check_pattern "XRAY UUID generation SSH"  "_generate_xray_uuid_ssh"
check_pattern "XRAY VLESS URL builder"    "_build_xray_vless_url"
check_pattern "XRAY status SSH"           "_get_xray_status_ssh"
check_pattern "XRAY add client SSH"       "_add_xray_client_ssh"
check_pattern "XRAY remove client SSH"    "_remove_xray_client_ssh"
...
echo ""
echo "── Real-time monitoring (SSE + event detection) ──"
check_pattern "SSE endpoint returns event-stream"  "text/event-stream"
check_pattern "Event detection function exists"    "_detect_monitoring_events"
check_pattern "Events history deque"               "_EVENTS_HISTORY"
check_pattern "Peer connected event type"          "peer_connected"
check_pattern "Peer disconnected event type"       "peer_disconnected"
check_pattern "Service status event types"         "service_up.*service_down"
check_pattern "Tunnel status event types"          "tunnel_up.*tunnel_down"
check_pattern "VPS online event type"              "vps_online"
check_pattern "VPS offline event type"             "vps_offline"
check_pattern "Active peers changed event"         "active_peers_changed"
check_pattern "SSE heartbeat/keep-alive"           "X-Accel-Buffering"
check_pattern "Event history endpoint"             "def monitoring_events"
check_pattern "SSE stream endpoint"                "def monitoring_stream"
